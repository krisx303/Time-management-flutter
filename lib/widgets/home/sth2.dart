...
Future<void> main() async {
  ...
  LinuxInitializationSettings(
    ...
    defaultIcon: AssetsLinuxIcon('assets/icons/calendar.png'),
  );
...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> asd() async {
    ...
    //   print("asd${i}");
    //   int j = maxProgress - i;
    //   String elapsed =  "${(i/60).round()}:${i%60}";
    //   String toEnd = "Do końca: ${(j/60).round().toString().padLeft(2, '0')}:${(j%60).toString().padLeft(2, '0')}";
  ...
  Future<void> _repeatNotification() async {
    ...
    await flutterLocalNotificationsPlugin.periodicallyShow(0, 'repeating title',
        DateTime.now().toString(), RepeatInterval.everyMinute, platformChannelSpecifics,
        androidAllowWhileIdle: true);
  }
